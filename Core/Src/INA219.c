...
void INA219_setCalibration_15V_5A(INA219_t *ina219)
{
	...
	ina219_calibrationValue = 4136;  //ina219_calibrationValue = 4462;
	ina219_currentDivider_mA = 6.5f;    // Current LSB = 0.0034A per bit (1000/40 = 25)
	ina219_powerMultiplier_mW = 3.0f; // Power LSB = 85.3mW per bit
